...
def run_compute_group_normalized_rewards(
    ...
    """
    # raise NotImplementedError
    from cs336_alignment.algs.grpo import compute_group_normalized_rewards
    ...
    return compute_group_normalized_rewards(
        ...
        normalized_by_std=normalize_by_std,
    )
...
def run_compute_naive_policy_gradient_loss(
    ...
    """
    # raise NotImplementedError
    from cs336_alignment.algs.grpo import compute_naive_policy_gradient_loss
...
def run_compute_grpo_clip_loss(
    ...
    """
    # raise NotImplementedError
    from cs336_alignment.algs.grpo import compute_grpo_clip_loss
...
def run_compute_policy_gradient_loss(
    ...
    """
    # raise NotImplementedError
    from cs336_alignment.algs.grpo import compute_policy_gradient_loss
...
def run_masked_mean(tensor: torch.Tensor, mask: torch.Tensor, dim: int | None = None) -> torch.Tensor:
    ...
    """
    # raise NotImplementedError
    from cs336_alignment.algs.grpo import masked_mean
...
def run_grpo_microbatch_train_step(
    ...
    """
    # raise NotImplementedError
    from cs336_alignment.algs.grpo import grpo_microbatch_train_step
